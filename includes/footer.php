<input type="hidden" value="<?= $user['id'] ?>" id='user_id_login'>
<footer id="footer">
...
quickview in 
fade in  -->
<div id="quickview-modal-3-13" class="modal fade " tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-footer">
                <div class="product-additional-info">
                    ...
                    <!-- end /var/www/html/demo/rb_evo_demo/themes/rb_evo/modules/ps_sharebuttons/views/templates/hook/ps_sharebuttons.tpl --><button
                        type="button" class="btn btn-primary rb-product-sizeguide">Size Guide</button>
                </div>
            </div>
        </div>
    </div>
