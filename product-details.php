<?php
    ...
    $DiscountPercentage = $ProductDetails['product_price'] / $ProductDetails['product_oldPrice'] * 100;
                ...
                <section id="main" itemscope itemtype="https://schema.org/Product">
                    ...
                    <div class="row">
                        ...
                        <div class="detail-padding-left col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-sp-12">
                            ...
                            <h1 class="h1 product-detail-name" itemprop="name"><?= $ProductDetails['product_name'] ?></h1>
                            ...
                            <div class="product-prices">
                                ...
                                <div class="product-attributes-label">
                                    ...
                                    <div class="product-quantities">
                                        ...
                                        <span data-stock="278"
                                            data-allow-oosp="0"><?= number_format($ProductDetails['total_stock'],1) ?>
                                            Items</span>
                                    </div>
                            ...
                            <div class="product-information">
                                ...
                                <div id="product-description-short-3" class="product-description"
                                    ...
                                    <p><?= $ProductDetails['product_desc_short'] ?>
                                </div>
                                        ...
                                        <div class="product-add-to-cart">
                                            ...
                                            <div class="compare-wishlist-button">
                                                ...
                                                <div class="rb-wishlist">
                                                    <a class="rb-wishlist-link rb-btn-product " href="#"
                                                        data-id-wishlist="" data-id-product="3"
                                                        data-id-product-attribute="13" data-id_wishlist_product="0"
                                ...
                                <div class="tab-content" id="tab-content">
                                        ...
                                        <div class="product-description">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <table
                                                        class="table table-striped table-borderless h-font text-uppercase"
                                    ...
                                    <div class="tab-pane fade" id="product-details"
                                        ...
                                        <div class="product-quantities">
                                            <label class="label">In stock</label>
                                            <span data-stock="899"
                                                data-allow-oosp="0"><?= $ProductDetails['total_stock'] ?></span>
                                        </div>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="star_content">
                                                                <input class="star not_uniform" type="radio"
                                                                    name="criterion" value="1">
                                                                <input class="star not_uniform" type="radio"
                                                                    name="criterion" value="2">
                                                                <input class="star not_uniform" type="radio"
                                                                    name="criterion" value="3">
                                                                <input class="star not_uniform" type="radio"
                                                                    name="criterion" value="4" checked="checked">
                                                                <input class="star not_uniform" type="radio"
                                                                    name="criterion" value="5">
                                                            </div>
                                                    ...
                                                    <form class="form-new-review" action="" method="POST">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="new_review_title" required=""
                                                                name="new_review_title">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" class="form-control"
                                                                id="rb_review_content" required=""
                                                                name="rb_review_content"></textarea>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="form-control-label"><sup>*</sup>
                                                                Required fields</label>
                                                            <input id="id_product_review" name="id_product_review"
                                                                type="hidden" value="3" />
                                                        </div>
                                        ...
                                        <div class="product-image">
                                            ...
                                            <div class="functional-buttons clearfix">
                                                ...
                                                <div class="product-add-cart">
                                                    <form action="https://rubiktheme.com/demo/rb_evo_demo/en/cart"
                                                        method="post" class="add-to-cart-or-refresh">
                                                        <input type="hidden" name="token"
                                                            value="9e645ea2b011b9302f90d49f848c7122">
                                                ...
                                                <div class="rb-wishlist">
                                                    <a class="rb-wishlist-link rb-btn-product " href="#"
                                                        data-id-wishlist="" data-id-product="17"
                                                        data-id-product-attribute="32" data-id_wishlist_product="0"
                                                        title="Add to Wishlist">
                                                        <i
                                                            class="icon-btn-product icon-wishlist icon-Icon_Wishlist"></i>
                                                        <span class="icon-title">Add to Wishlist</span>
                                                ...
                                                <div class="product-quickview hidden-sm-down">
                                                    <a class="rb-quick-view rb-btn-product" href="#"
                                                ...
                                                <div class="product-quick-view" style="display:none;">
                                                    <a class="quick-view rb-btn-product" href="#"
                                                        data-link-action="quickview">
                                    ...
                                    <div class="thumbnail-container">
                                        <div class="product-image">
                                            ...
                                            <div class="functional-buttons clearfix">
                                                ...
                                                <div class="rb-wishlist">
                                                    <a class="rb-wishlist-link rb-btn-product " href="#"
                                                        data-id-wishlist="" data-id-product="11"
                                                        data-id-product-attribute="26" data-id_wishlist_product="0"
                                                        title="Add to Wishlist">
                                                        <i
                                                            class="icon-btn-product icon-wishlist icon-Icon_Wishlist"></i>
                                                        <span class="icon-title">Add to Wishlist</span>
                                    ...
                                    <div class="thumbnail-container">
                                        <div class="product-image">
                                            ...
                                            <div class="functional-buttons clearfix">
                                                ...
                                                <div class="rb-wishlist">
                                                    <a class="rb-wishlist-link rb-btn-product " href="#"
                                                        data-id-wishlist="" data-id-product="9"
                                                        data-id-product-attribute="22" data-id_wishlist_product="0"
                                                        title="Add to Wishlist">
                                                        <i
                                                            class="icon-btn-product icon-wishlist icon-Icon_Wishlist"></i>
                                                        <span class="icon-title">Add to Wishlist</span>
                                    ...
                                    <div class="thumbnail-container">
                                        <div class="product-image">
                                            ...
                                            <div class="functional-buttons clearfix">
                                                ...
                                                <div class="rb-wishlist">
                                                    <a class="rb-wishlist-link rb-btn-product " href="#"
                                                        data-id-wishlist="" data-id-product="1"
                                                        data-id-product-attribute="1" data-id_wishlist_product="0"
                                                        title="Add to Wishlist">
                                                        <i
                                                            class="icon-btn-product icon-wishlist icon-Icon_Wishlist"></i>
                                                        <span class="icon-title">Add to Wishlist</span>
